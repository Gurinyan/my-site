...
import { BookOpen, ChevronDown, Menu, X, Feather } from "lucide-react";
    ...
    >
      <div className="relative" style={{ width: 88, height: "65vh" }}>
        ...
        <div
          ...
          style={{ right: 0, width: 1, height: "100%", background: "rgba(255,255,255,0.08)" }}
        />
        {/* Fill */}
        <div
          className="absolute top-0"
          ...
          return (
            ...
            >
              ...
              <span
                ...
                style={{
                  marginRight: 10,
                  color: isActive ? "rgba(255,218,182,0.9)" : "rgba(255,218,182,0.2)",
                  whiteSpace: "nowrap",
                }}
              >
                {book.year.replace("年", "")}
      ...
      <div className="mx-auto max-w-6xl px-6" ref={contentRef}>
        ...
        <div className="mb-10 flex items-end gap-4">
          <span
            ...
            style={{ fontSize: "5rem", color: "rgba(255,195,150,0.18)" }}
          >
            {book.roman}
          </span>
          <span className="mb-2 text-xs tracking-[0.3em]" style={{ color: "rgba(255,215,178,0.45)" }}>
            {book.label}
          </span>
        </div>
        ...
        <div ref={ref} className="flex flex-col items-start gap-10 md:flex-row lg:gap-16">
          ...
          >
            <div
              ...
              style={{ boxShadow: "0 24px 60px rgba(0,0,0,0.7), 0 0 0 1px rgba(80,80,80,0.2)" }}
            >
              {!imgErr ? (
                <Image
                  src="/images/ayatsuji.jpg"
                  alt="綾辻行人"
                  fill
                ...
                <div
                  ...
                  style={{ background: "linear-gradient(160deg, #1a0808, #2d1212, #1a0808)" }}
                >
                  <div className="absolute left-0 top-0 h-full w-1" style={{ background: "linear-gradient(to bottom, #8b0000, #4a0000)" }} />
          ...
          >
            ...
            <p className="mb-6 text-[11px] tracking-[0.35em]" style={{ color: "#8b0000" }}>
              Yukito Ayatsuji
            </p>
...
const BOOKS = [
  {
    id: 1, roman: "I", label: "第1作", year: "1987年",
    title: "十角館の殺人",
    image: "/images/jukkakukan.jpg",
    tagline: "ただ一行が、全てを覆す。",
    synopsis: "本格推理小説研究会の七人が招かれた、孤島に建つ十角形の奇妙な館。嵐によって外界との連絡を絶たれた状況で、一人また一人と不可解な死が続く。館での連続殺人と、本土で繰り広げられる別の調査。二つの事件が交差した瞬間、読者の前に突きつけられるたった一行の真実が、物語の全てをひっくり返す。1987年のデビュー以来、日本中の読者を震撼させ続ける「新本格」ミステリの原点。",
  },
  {
    id: 2, roman: "II", label: "第2作", year: "1988年",
    title: "水車館の殺人",
    image: "/images/suishakan.jpg",
    tagline: "過去と現在が交差する、廻り続ける謎。",
    synopsis: "瀬戸内の美しい景色の中に建つ、水車のある奇妙な洋館。盲目の主人・藤沼一成と、謎の仮面を被った青年・紀一。そして招かれた客たちの間に漂う不穏な空気。一年前の事件の記憶と現在の連続殺人が複雑に絡み合いながら、物語はある驚愕の真実へと向かう。時間軸を大胆に操るタイム・ラグ構造が冴え渡る、館シリーズ第二弾。",
  },
  {
    id: 3, roman: "III", label: "第3作", year: "1988年",
    title: "迷路館の殺人",
    image: "/images/meirokan.jpg",
    tagline: "作中に潜む作中。謎の奥に謎がある。",
    synopsis: "山中に佇む、地下に巨大な迷路を持つ奇妙な館。招かれた四人の作家候補生たちは、館の主人から奇妙な条件のもとでミステリ小説の執筆を命じられる。しかし現実の館でも、次々と人が死んでいく。「作中作」という大胆なメタ構造を採用し、本格ミステリの可能性を大きく広げた野心作。",
  },
  {
    id: 4, roman: "IV", label: "第4作", year: "1989年",
    title: "人形館の殺人",
    image: "/images/ningyokan.jpg",
    tagline: "無数の瞳が、あなたを見ている。",
    synopsis: "幼少期を過ごした屋敷を相続した主人公・飛龍想一。そこには無数の人形が飾られ、奇妙な脅迫状が届き始める。精神を蝕む恐怖と幻覚、館に充満する狂気。シリーズ唯一の一人称語りで描かれる心理サスペンスは、ホラーとミステリを融合させた異色作。アリバイ崩しの名手による、読者の予想を超えた結末が待つ。",
  },
  {
    id: 5, roman: "V", label: "第5作", year: "1991年",
    title: "時計館の殺人",
    image: "/images/tokeikan.jpg",
    tagline: "時計は止まらない。死も、また。",
    synopsis: "廃屋同然の洋館に数百の時計が刻み続ける、奇妙な時の流れ。心霊現象の調査に訪れた研究者たちは、館の中で外界から完全に孤立してしまう。行方不明の少女の亡霊が目撃される中、現実の殺人が次々と起こる。シリーズ最長作にして、多くの読者がシリーズ最高傑作と称える一作。",
  },
  {
    id: 6, roman: "VI", label: "第6作", year: "1992年",
    title: "黒猫館の殺人",
    image: "/images/kuronekkan.jpg",
    tagline: "記憶のない男が目覚めた館の秘密。",
    synopsis: "記憶を完全に失った男が目覚めると、そこは黒猫の絵が随所に飾られた奇妙な館だった。自分が誰なのかを探りながら館の謎に迫っていく主人公。北海道と京都、二つの場所で同時進行する物語はやがて一つの驚愕の真実へと収束する。南北を結ぶ大胆なトリックと、記憶と同一性というテーマが融合した第六弾。",
  },
  {
    id: 7, roman: "VII", label: "第7作", year: "2004年",
    title: "暗黒館の殺人",
    image: "/images/ankokukan.jpg",
    tagline: "最も深く、最も暗い迷宮へ。",
    synopsis: "湖上に建つ浦登家の巨大な館。代々伝わる禁忌と謎の風習、そして奇怪な料理「カリュカ」。シリーズ最長・最重量作にして、最もダークな物語。探偵・江南孝明が挑む浦登家の秘密は、人間の業と本質にまで迫る深遠なテーマを持つ。四分冊で刊行された大作であり、館シリーズ全体を通底する謎に踏み込む集大成的位置づけを持つ。",
  },
  {
    id: 8, roman: "VIII", label: "第8作", year: "2006年",
    title: "びっくり館の殺人",
    image: "/images/bikkurikan.jpg",
    tagline: "少年の目が見た、クリスマスの悪夢。",
    synopsis: "クリスマスの夜、少年・俊生が招かれた「びっくり館」と呼ばれる屋敷。腹話術師の老人とその人形「三楽」が支配するその館で、密室殺人事件が起きる。唯一の目撃者は人形だった。少年の視点から描かれるシリーズ唯一の作品は、童話的な恐怖と論理的なミステリを融合させた短編的秀作。",
  },
  {
    id: 9, roman: "IX", label: "第9作", year: "2012年",
    title: "奇面館の殺人",
    image: "/images/kimengakan.jpg",
    tagline: "仮面の下に、名前はない。",
    synopsis: "猛吹雪によって孤立した、奇妙な仮面飾りに満ちた屋敷「奇面館」。館の主人・影山逸史は招待客全員に異様な仮面を被ることを強要し、館内では誰が誰か分からない状況が作り出される。その状況下で、首のない死体が発見される。全員が匿名という前代未聞の設定が生み出す密室劇。",
  },
];

const NAV_LINKS = ["作品一覧", "著者紹介", "館の系譜"];
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      bookSectionRefs.current.forEach((el, i) => {
        ...
        if (rect.top < vh * 0.55) newActive = i;
      });
    ...
    <div className="min-h-screen">
      ...
      >
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 md:py-5">
          ...
          <div className="hidden items-center gap-8 md:flex">
            {NAV_LINKS.map((label) => (
              <a
                key={label}
                href={`#${label}`}
                className="group relative text-sm tracking-widest text-stone-300 transition-colors duration-200 hover:text-stone-100"
              >
                {label}
          ...
          <button
            className="text-stone-300 transition-colors hover:text-stone-100 md:hidden"
          ...
          <div className="border-t border-stone-800/60 md:hidden" style={{ background: "rgba(6,6,6,0.96)" }}>
            {NAV_LINKS.map((label) => (
              <a
                key={label}
                href={`#${label}`}
                className="block px-6 py-4 text-sm tracking-widest text-stone-300 transition-colors hover:bg-stone-900/40 hover:text-stone-100"
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 text-center">
        <div
          ...
          style={{
            backgroundImage: `repeating-linear-gradient(
              45deg, rgba(139,0,0,0.6) 0px, rgba(139,0,0,0.6) 1px,
        ...
        <div className="relative z-10 max-w-4xl">
          <div className="anim-0 mb-8 flex items-center justify-center gap-3">
            ...
            <span className="text-[10px] tracking-[0.4em] uppercase" style={{ color: "#8b0000" }}>
          ...
          <h1
            className="anim-1 mb-6 text-4xl font-bold leading-snug tracking-[0.06em] text-stone-100 sm:text-5xl md:text-6xl lg:text-7xl"
            style={{ textShadow: "0 0 60px rgba(139,0,0,0.15)" }}
          >
            十角館から始まる、
            <br />
          ...
          <p className="anim-2 mb-3 text-sm tracking-[0.25em]" style={{ color: "rgba(255,225,200,0.62)" }}>
            綾辻行人 / 館シリーズ 全9作品
          </p>
          <p className="anim-3 text-xs tracking-[0.2em]" style={{ color: "rgba(255,215,178,0.4)" }}>
            Rui Takano | Computer Science Student
          </p>
        </div>
      ...
      <section id="作品一覧">
        ...
        {BOOKS.map((book, i) => (
          <BookSection
            ...
            book={book}
            reverse={book.id % 2 === 0}
            onRef={(el) => { bookSectionRefs.current[i] = el; }}
          />
        ))}
      </section>
      ...
      <section id="館の系譜" className="border-t px-6 py-24" style={{ borderColor: "rgba(38,38,38,0.6)" }}>
        <div className="mx-auto max-w-7xl text-center">
          ...
          <p className="mb-14 text-sm tracking-wider" style={{ color: "rgba(255,220,190,0.55)" }}>
            1987年から続く、館と謎の年代記
          </p>
            ...
            {BOOKS.map((book, i) => (
              <div key={book.id} className="flex items-start">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <p className="text-[10px] tracking-widest" style={{ color: "rgba(255,215,178,0.45)" }}>
                    {book.year.replace("年", "")}
                  </p>
                  <p className="mt-1 max-w-[64px] text-center text-[11px] leading-snug" style={{ color: "rgba(255,220,190,0.6)" }}>
                    {book.title.replace("の殺人", "")}
                  </p>
                </div>
                {i < BOOKS.length - 1 && (
                  <div className="mt-1.5 hidden h-px w-10 md:block lg:w-14" style={{ background: "rgba(139,0,0,0.2)" }} />
                )}
              </div>
            ))}
          </div>
      ...
      <footer className="border-t px-6 py-10 text-center" style={{ borderColor: "rgba(28,28,28,0.8)" }}>
        <p className="mb-1 text-xs tracking-widest" style={{ color: "rgba(255,210,175,0.28)" }}>
          © 2024 館シリーズ ファンサイト — 非公式ファンページ
        </p>
        <p className="text-xs tracking-widest" style={{ color: "rgba(255,205,168,0.18)" }}>
          Rui Takano | Computer Science Student
        </p>
      </footer>
    </div>
